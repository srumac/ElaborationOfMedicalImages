function [ index_P,n,win ] = use_cascade( cascade, img , num_FP)
...
%   'win': the number of considered subwindows
% % % % % % %
    ...
    while ( i <= size(A,2) ) 
        ...
        if devstan > 0.01
            ...
            for k = 1:size(cascade,2)
                ...
                % save the current strong classifier and its shift
                layer = cascade{1,k}; 
                shift = cascade{2,k};
